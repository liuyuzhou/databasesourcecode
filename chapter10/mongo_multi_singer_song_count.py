import math
import requests
from chapter10.database.mongo_conn import col_singer_song
from chapter10.database.music_model import SingerSong
...
def get_singer_songs(singer_mid):
    try:
        ...
        """
        url = 'https://c.y.qq.com/v8/fcg-bin/fcg_v8_singer_track_cp.fcg?loginUin=0&' \
              'hostUin=0&singermid={}' \
        ...
        # 歌手歌曲总数持久化
        val_dict = {"song_singer": song_singer, "song_count": song_count, "singer_mid": singer_mid}
        # 歌手歌曲总数持久化到 MongoDB
        col_singer_song().insert_one(val_dict)
