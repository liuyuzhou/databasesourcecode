...
# 建立链接
engine = create_engine('mysql+pymysql://root:root@localhost/data_school?charset=utf8',
...
class NLPAnalysis(Base):
    ...
    question_title = Column(String(200), default=None, comment='问题标题')
    question_answer = Column(String(500), default=None, comment='问题答案')
    fen_ci_result = Column(String(1000), default=None, comment='标题分词结果')
